...
# This version sourced from https://github.com/google-research/federated/tree/master/robust_aggregation.
# Indentation modified to match existing files in this codebase. Updated to current version of TFF.
# Removed unnecessary build_federated_avgeraging_process function.
...
class RobustWeiszfeldFactory(tff.aggregators.WeightedAggregationFactory):
    ...
    def create(self, value_type, weight_type):
        ...
        @tff.tensorflow.computation(tf.float32, value_type, value_type)

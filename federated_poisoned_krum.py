...
for i in range(len(split_train_label[attacker])):
    split_train_label[attacker][i] = int(np.where(label_encoder.classes_ == 'Normal')[0])
...
"""
KRUM is an alterante method of aggregating the results of all the clients. 
